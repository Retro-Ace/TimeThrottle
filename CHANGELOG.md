...
- Tightens active-drive, setup, and trip-result layouts without changing Apple Maps ETA baseline route mode, Trip History, Scanner, route weather, aircraft, or enforcement data sources.
...
- Menu keeps route intelligence details, alert filters, and audio cue controls out of the always-visible map.
