...
struct RoutePreviewMapView: NSViewRepresentable {
    ...
    final class Coordinator: NSObject, MKMapViewDelegate {
        ...
        func mapView(_ mapView: MKMapView, rendererFor overlay: MKOverlay) -> MKOverlayRenderer {
            ...
            renderer.strokeColor = isSelected ? NSColor.systemBlue : NSColor.systemBlue.withAlphaComponent(0.28)
        ...
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            ...
            if annotation.title == "Start" {
                ...
                view.glyphImage = NSImage(systemSymbolName: "play.fill", accessibilityDescription: nil)
            } else {
